...
obj_out_df = pd.DataFrame(columns=['image name', 'sum of mito area', 'number of tRNAs', 'sum of tRNAs area', 'avg tRNAs area',
                                   'number of MRPL23', 'sum of MRPL23 area', 'avg of MRPL23 area',
                                   'number of MRPL23 in tRNAs', 'percent of MRPL23 in tRNAs',
                                   'avg percent of simulated MRPL23 in tRNAs', 'std percent of simulated MRPL23 in tRNAs'])
...
for file in os.listdir(file_path):
    ...
    obj2_df = df[df['Tags'].str.contains(', MRPL23,')].reset_index(drop=True)
    ...
    obj2_in_obj1 = len(obj2_df[obj2_df['Tags'].str.contains(', MRPL23 in Mito Clean in tRNAs Thresholded in Mito Clean')].reset_index(drop=True))
