...
obj_out_df = pd.DataFrame(columns=['image name', 'sum of mito area', 'number of HPG', 'sum of HPG area', 'avg HPG area',
                                   'number of GRSF1', 'sum of GRSF1 area', 'avg of GRSF1 area', 'number of GRSF1 in HPG', 'percent of GRSF1 in HPG',
                                   'avg percent of simulated GRSF1 in HPG', 'std percent of simulated GRSF1 in HPG'])
...
for file in os.listdir(file_path):
    ...
    obj2_in_obj1 = len(obj2_df[obj2_df['Tags'].str.contains(', GRSF1 in Mito Clean in HPG thresholded in Mito Clean')].reset_index(drop=True))
