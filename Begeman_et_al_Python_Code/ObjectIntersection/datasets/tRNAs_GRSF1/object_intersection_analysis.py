...
obj_out_df = pd.DataFrame(columns=['image name', 'sum of mito area', 'number of tRNAs', 'sum of tRNAs area', 'avg tRNAs area',
                                   'number of GRSF1', 'sum of GRSF1 area', 'avg of GRSF1 area',
                                   'number of DNA', 'sum of DNA area', 'avg DNA area',
                                   'number of GRSF1 in tRNAs', 'percent of GRSF1 in tRNAs',
                                   'avg percent of simulated GRSF1 in tRNAs', 'std percent of simulated GRSF1 in tRNAs',
                                   'number of DNA in tRNAs', 'percent of DNA in tRNAs',
                                   'avg percent of simulated DNA in tRNAs', 'std percent of simulated DNA in tRNAs'])
...
for file in os.listdir(file_path):
    ...
    obj1_df = df[df['Tags'].str.contains(', tRNAs Thresholded,')].reset_index(drop=True)
    ...
    obj2_in_obj1 = len(obj2_df[obj2_df['Tags'].str.contains(', GRSF1 in Mito Clean in tRNAs Thresholded in Mito Clean')].reset_index(drop=True))
    percent_obj2_in_obj1 = 100.0 * (obj2_in_obj1 / obj2_number)
    obj3_in_obj1 = len(obj3_df[obj3_df['Tags'].str.contains(', DNA in Mito Clean in tRNAs Thresholded in Mito Clean')].reset_index(drop=True))
