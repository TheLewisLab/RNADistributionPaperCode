...
obj_out_df = pd.DataFrame(columns=['image name', 'sum of mito area', 'number of EU', 'sum of EU area', 'avg EU area',
                                   'number of GRSF1', 'sum of GRSF1 area', 'avg of GRSF1 area',
                                   'number of EU in GRSF1', 'percent of EU in GRSF1',
                                   'avg percent of simulated EU in GRSF1', 'std percent of simulated EU in GRSF1'
                                   ])
...
for file in os.listdir(file_path):
    ...
    obj1_df = df[df['Tags'].str.contains(', EU,')].reset_index(drop=True)
    ...
    obj1_in_obj2 = len(obj1_df[obj1_df['Tags'].str.contains(', EU in Mito Clean in GRSF1 in Mito Clean')].reset_index(drop=True))
