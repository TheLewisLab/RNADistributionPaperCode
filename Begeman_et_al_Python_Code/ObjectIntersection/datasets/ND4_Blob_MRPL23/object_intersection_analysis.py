...
obj_out_df = pd.DataFrame(columns=['image name', 'sum of mito area', 'number of ND4', 'sum of ND4 area', 'avg ND4 area',
                                   ...
                                   'number of ND4 with MRPL23', 'percent of ND4 with MRPL23',
                                   'avg percent of simulated ND4 with MRPL23', 'std percent of simulated ND4 with MRPL23'
                                   ])
...
for file in os.listdir(file_path):
    ...
    obj1_in_obj2 = len(obj1_df[obj1_df['Tags'].str.contains(', ND4 Blob Finder in Mito Clean with MRPL23 in Mito Clean')].reset_index(drop=True))
