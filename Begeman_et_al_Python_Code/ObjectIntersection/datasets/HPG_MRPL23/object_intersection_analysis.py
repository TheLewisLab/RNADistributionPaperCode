...
obj_out_df = pd.DataFrame(columns=['image name', 'sum of mito area', 'number of HPG', 'sum of HPG area', 'avg HPG area',
                                   'number of MRPL23', 'sum of MRPL23 area', 'avg of MRPL23 area', 'number of MRPL23 in HPG', 'percent of MRPL23 in HPG',
                                   'avg percent of simulated MRPL23 in HPG', 'std percent of simulated MRPL23 in HPG'])
...
for file in os.listdir(file_path):
    ...
    obj2_in_obj1 = len(obj2_df[obj2_df['Tags'].str.contains(', MRPL23 in Mito Clean in HPG thresholded in Mito Clean')].reset_index(drop=True))
