...
obj_out_df = pd.DataFrame(columns=['image name', 'sum of mito area', 'number of HPG', 'sum of HPG area', 'avg HPG area',
                                   'number of tRNAs', 'sum of tRNAs area', 'avg of tRNAs area',
                                   'number of HPG in tRNAs', 'percent of HPG in tRNAs',
                                   'avg percent of simulated HPG in tRNAs', 'std percent of simulated HPG in tRNAs'])
...
for file in os.listdir(file_path):
    ...
    obj2_in_obj1 = len(obj2_df[obj2_df['Tags'].str.contains(', HPG Thresholded in Mito Clean in tRNAs Thresholded in Mito Clean')].reset_index(drop=True))
