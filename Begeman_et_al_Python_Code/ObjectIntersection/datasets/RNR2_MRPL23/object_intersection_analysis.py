...
obj_out_df = pd.DataFrame(columns=['image name', 'sum of mito area', 'number of RNR2', 'sum of RNR2 area', 'avg RNR2 area',
                                   ...
                                   'number of MRPL23 in RNR2', 'percent of MRPL23 in RNR2',
                                   'avg percent of simulated MRPL23 in RNR2', 'std percent of simulated MRPL23 in RNR2'])
...
for file in os.listdir(file_path):
    ...
    obj2_in_obj1 = len(obj2_df[obj2_df['Tags'].str.contains(', MRPL23 in Mito Clean in RNR2 Thresholded in Mito Clean')].reset_index(drop=True))
